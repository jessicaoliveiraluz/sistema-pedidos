...
public class PedidoMapper {
    ...
    public static PedidoResponseDTO toDTO(Pedido pedido) {
        List<ItemPedidoDTO> itens = Optional.ofNullable(pedido.getProdutos())
                .orElse(List.of())  // lista vazia se for null
                .stream()
                .map(produto -> {
        ...
        dto.setDataHora(pedido.getDataHora() != null ? pedido.getDataHora() : null);
